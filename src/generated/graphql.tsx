...
export type RocketInfoQuery = {
  ...
  ship?: {
    ...
    missions?: Array<{ __typename?: 'BasicMission'; name?: string | null } | null> | null;
  } | null;
};

export type ShipsListQueryVariables = Exact<{ [key: string]: never }>;
 ...
 * });
 */
export function useRocketInfoQuery(
  baseOptions: Apollo.QueryHookOptions<RocketInfoQuery, RocketInfoQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<RocketInfoQuery, RocketInfoQueryVariables>(RocketInfoDocument, options);
}
export function useRocketInfoLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<RocketInfoQuery, RocketInfoQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<RocketInfoQuery, RocketInfoQueryVariables>(
    RocketInfoDocument,
    options
  );
}
...
export const ShipsListDocument = gql`
  query ShipsList {
    ships {
      ship_id
      ship_name
...
/**
 * __useShipsListQuery__
 *
 * To run a query within a React component, call `useShipsListQuery` and pass it any options that fit your needs.
 * When your component renders, `useShipsListQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useShipsListQuery({
 *   variables: {
 *   },
 * });
 */
export function useShipsListQuery(
  baseOptions?: Apollo.QueryHookOptions<ShipsListQuery, ShipsListQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<ShipsListQuery, ShipsListQueryVariables>(ShipsListDocument, options);
}
export function useShipsListLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<ShipsListQuery, ShipsListQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<ShipsListQuery, ShipsListQueryVariables>(ShipsListDocument, options);
}
export type ShipsListQueryHookResult = ReturnType<typeof useShipsListQuery>;
export type ShipsListLazyQueryHookResult = ReturnType<typeof useShipsListLazyQuery>;
export type ShipsListQueryResult = Apollo.QueryResult<ShipsListQuery, ShipsListQueryVariables>;
